...
def main():
    ...
    parser.add_argument("--info",required=False,default='input.txt',help='Memory Info File Path',type=str)
    parser.add_argument("--log",required=False,default='log.txt',help='Log File Path',type=str)
    parser.add_argument("--algorithm",required=True,help='Select Memory Replacement Algorithm',type=str)
    args = parser.parse_args()

    vmm = VirtualMemoryManagement(args.info,args.log)
    vmm.check_argv()
    vmm.operate(args.algorithm)
